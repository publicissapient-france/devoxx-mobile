...
var Lawnchair=function(){if(!JSON)throw"JSON unavailable! Include http://www.json.org/json2.js to fix.";if(arguments.length<=2&&arguments.length>0)var a=typeof arguments[0]==="function"?arguments[0]:arguments[1],b=typeof arguments[0]==="function"?{}:arguments[0];else throw"Incorrect # of ctor args!";if(typeof a!=="function")throw"No callback was provided";var c=!(this instanceof Lawnchair)?new Lawnchair(b,a):this;c.record=b.record||"record";c.name=b.name||"records";var d;if(b.adapter){d=Lawnchair.adapters[c.indexOf(Lawnchair.adapters,b.adapter)];d=d.valid()?d:undefined}else for(var e=0,f=Lawnchair.adapters.length;e<f;e++)if(d=Lawnchair.adapters[e].valid()?Lawnchair.adapters[e]:undefined)break;if(!d)throw"No valid adapter.";for(var g in d)c[g]=d[g];e=0;for(f=Lawnchair.plugins.length;e<f;e++)Lawnchair.plugins[e].call(c);c.init(b,a);return c};Lawnchair.adapters=[];Lawnchair.adapter=function(a,b){b.adapter=a;var c="adapter valid init keys save batch get exists all remove nuke".split(" "),d=this.prototype.indexOf,e;for(e in b)if(d(c,e)===-1)throw"Invalid adapter! Nonstandard method: "+e;Lawnchair.adapters.push(b)};Lawnchair.plugins=[];Lawnchair.plugin=function(a){for(var b in a)b==="init"?Lawnchair.plugins.push(a[b]):this.prototype[b]=a[b]};Lawnchair.prototype={isArray:Array.isArray||function(a){return Object.prototype.toString.call(a)==="[object Array]"},indexOf:function(a,b,c,d){if(a.indexOf)return a.indexOf(b);c=0;for(d=a.length;c<d;c++)if(a[c]===b)return c;return-1},lambda:function(a){return this.fn(this.record,a)},fn:function(a,b){return typeof b=="string"?new Function(a,b):b},uuid:function(){var a=function(){return((1+Math.random())*65536|0).toString(16).substring(1)};return a()+a()+"-"+a()+"-"+a()+"-"+a()+"-"+a()+a()+a()},each:function(a){var b=this.lambda(a);if(this.__results){a=0;for(var c=this.__results.length;a<c;a++)b.call(this,this.__results[a],a)}else this.all(function(a){for(var c=0,d=a.length;c<d;c++)b.call(this,a[c],c)});return this}};Lawnchair.adapter("dom",{valid:function(){return!!window.Storage},init:function(a,b){this.storage=window.localStorage;var c=this;this.indexer={key:c.name+"._index_",all:function(){JSON.parse(c.storage.getItem(this.key))==null&&c.storage.setItem(this.key,JSON.stringify([]));return JSON.parse(c.storage.getItem(this.key))},add:function(a){var b=this.all();b.push(a);c.storage.setItem(this.key,JSON.stringify(b))},del:function(a){for(var b=this.all(),d=[],f=0,g=b.length;f<g;f++)b[f]!=a&&d.push(b[f]);c.storage.setItem(this.key,JSON.stringify(d))},find:function(a){for(var b=this.all(),c=0,d=b.length;c<d;c++)if(a===b[c])return c;return false}};b&&this.fn(this.name,b).call(this,this)},save:function(a,b){var c=a.key||this.uuid();this.indexer.find(c)||this.indexer.add(c);delete a.key;this.storage.setItem(c,JSON.stringify(a));if(b){a.key=c;this.lambda(b).call(this,a)}return this},batch:function(a,b){for(var c=[],d=0,e=a.length;d<e;d++)this.save(a[d],function(a){c.push(a)});b&&this.lambda(b).call(this,c);return this},keys:function(){callback&&this.lambda(callback).call(this,this.indexer.all())},get:function(a,b){if(this.isArray(a)){for(var c=[],d=0,e=a.length;d<e;d++){var f=JSON.parse(this.storage.getItem(a[d]));if(f){f.key=a[d];c.push(f)}}b&&this.lambda(b).call(this,c)}else{if(f=JSON.parse(this.storage.getItem(a)))f.key=a;b&&this.lambda(b).call(this,f)}return this},all:function(a){for(var b=this.indexer.all(),c=[],d,e=0,f=b.length;e<f;e++){d=JSON.parse(this.storage.getItem(b[e]));d.key=b[e];c.push(d)}a&&this.fn(this.name,a).call(this,c);return this},remove:function(a,b){var c=typeof a==="string"?a:a.key;this.indexer.del(c);this.storage.removeItem(c);b&&this.lambda(b).call(this);return this},nuke:function(a){this.all(function(b){for(var c=0,d=b.length;c<d;c++)this.remove(b[c]);a&&this.lambda(a).call(this)});return this}});Lawnchair.adapter("window-name",function(a,b){var c=window.top.name?JSON.parse(window.top.name):{};return{valid:function(){return typeof window.top.name!="undefined"},init:function(d,f){c[this.name]={index:[],store:{}};a=c[this.name].index;b=c[this.name].store;this.fn(this.name,f).call(this,this)},keys:function(b){this.fn("keys",b).call(this,a);return this},save:function(d,f){var g=d.key||this.uuid();d.key&&delete d.key;this.exists(g,function(h){h||a.push(g);b[g]=d;window.top.name=JSON.stringify(c);if(f){d.key=g;this.lambda(f).call(this,d)}});return this},batch:function(a,b){for(var c=[],d=0,e=a.length;d<e;d++)this.save(a[d],function(a){c.push(a)});b&&this.lambda(b).call(this,c);return this},get:function(a,c){var d;if(this.isArray(a)){d=[];for(var e=0,f=a.length;e<f;e++)d.push(b[a[e]])}else if(d=b[a])d.key=a;c&&this.lambda(c).call(this,d);return this},exists:function(a,c){this.lambda(c).call(this,!!b[a]);return this},all:function(c){for(var d=[],e=0,f=a.length;e<f;e++){var g=b[a[e]];g.key=a[e];d.push(g)}this.fn(this.name,c).call(this,d);return this},remove:function(d,f){for(var g=this.isArray(d)?d:[d],h=0,i=g.length;h<i;h++){delete b[g[h]];a.splice(this.indexOf(a,g[h]),1)}window.top.name=JSON.stringify(c);f&&this.lambda(f).call(this);return this},nuke:function(b){storage={};a=[];window.top.name=JSON.stringify(c);b&&this.lambda(b).call(this);return this}}}())

// lawnchair-adapter-webkit-sqlite-0.6.1.min.js
Lawnchair.adapter("webkit-sqlite",function(){var a=function(a,b){console.log("error in sqlite adaptor!",a,b)},b=function(){return new Date};if(!Function.prototype.bind){Function.prototype.bind=function(a){var b=[].slice,c=b.call(arguments,1),d=this,e=function(){},f=function(){return d.apply(this instanceof e?this:a||{},c.concat(b.call(arguments)))};e.prototype=d.prototype;f.prototype=new e;return f}}return{valid:function(){return!!window.openDatabase},init:function(b,c){var d=this,e=d.fn(d.name,c),f="CREATE TABLE IF NOT EXISTS "+this.name+" (id NVARCHAR(32) UNIQUE PRIMARY KEY, value TEXT, timestamp REAL)",g=function(){return e.call(d,d)};this.db=openDatabase(this.name,"1.0.0",this.name,65536);this.db.transaction(function(b){b.executeSql(f,[],g,a)})},keys:function(b){var c=this.lambda(b),d=this,e="SELECT id FROM "+this.name+" ORDER BY timestamp DESC";this.db.transaction(function(b){var f=function(a,b){if(b.rows.length==0){c.call(d,[])}else{var e=[];for(var f=0,g=b.rows.length;f<g;f++){e.push(b.rows.item(f).id)}c.call(d,e)}};b.executeSql(e,[],f,a)});return this},save:function(c,d){var e=this,f=c.key||e.uuid(),g="INSERT INTO "+this.name+" (value, timestamp, id) VALUES (?,?,?)",h="UPDATE "+this.name+" SET value=?, timestamp=? WHERE id=?",i=function(){if(d){c.key=f;e.lambda(d).call(e,c)}},j=[b(),f];e.exists(c.key,function(b){e.db.transaction(function(d){var e=function(b){j.unshift(JSON.stringify(b));d.executeSql(g,j,i,a)};var f=function(b){delete b.key;j.unshift(JSON.stringify(b));d.executeSql(h,j,i,a)};b?f(c):e(c)})});return this},batch:function(a,b){var c=[],d=false,e=this;var f=function(b){c.push(b);d=c.length===a.length};var g=setInterval(function(){if(d){if(b)e.lambda(b).call(e,c);clearInterval(g)}},200);for(var h=0,i=a.length;h<i;h++)this.save(a[h],f);return this},get:function(b,c){var d=this,e="";if(this.isArray(b)){e="SELECT id, value FROM "+this.name+" WHERE id IN ('"+b.join("','")+"')"}else{e="SELECT id, value FROM "+this.name+" WHERE id = '"+b+"'"}var f=function(a,e){var f=null,g=[];if(e.rows.length){for(var h=0,i=e.rows.length;h<i;h++){f=JSON.parse(e.rows.item(h).value);f.key=e.rows.item(h).id;g.push(f)}}if(!d.isArray(b))g=g.length?g[0]:null;if(c)d.lambda(c).call(d,g)};this.db.transaction(function(b){b.executeSql(e,[],f,a)});return this},exists:function(b,c){var d="SELECT * FROM "+this.name+" WHERE id = ?",e=this,f=function(a,b){if(c)e.fn("exists",c).call(e,b.rows.length>0)};this.db.transaction(function(c){c.executeSql(d,[b],f,a)});return this},all:function(b){var c=this,d="SELECT * FROM "+this.name,e=[],f=this.fn(this.name,b)||undefined,g=function(a,b){if(b.rows.length!=0){for(var d=0,g=b.rows.length;d<g;d++){var h=JSON.parse(b.rows.item(d).value);h.key=b.rows.item(d).id;e.push(h)}}if(f)f.call(c,e)};this.db.transaction(function(b){b.executeSql(d,[],g,a)});return this},remove:function(b,c){var d=this,e=typeof b==="string"?b:b.key,f="DELETE FROM "+this.name+" WHERE id = ?",g=function(){if(c)d.lambda(c).call(d)};this.db.transaction(function(b){b.executeSql(f,[e],g,a)});return this},nuke:function(b){var c="DELETE FROM "+this.name,d=this,e=b?function(){d.lambda(b).call(d)}:function(){};this.db.transaction(function(b){b.executeSql(c,[],e,a)});return this}}}())

// lawnchair-aggregation-0.6.1.min.js
Lawnchair.plugin({count:function(a,b){if([].slice.call(arguments).length===1){b=a;a="key"}var c=0;this.each(function(b){if(b[a])c++});this.fn("count",b).call(this,c)},sum:function(a,b){var c=0;this.each(function(b){if(b[a])c+=b[a]});this.fn("sum",b).call(this,c)},avg:function(a,b){this.sum(a,function(c){this.count(a,function(a){this.fn("avg",b).call(this,c/a)})})},min:function(a,b){this._minOrMax("min",a,b)},max:function(a,b){this._minOrMax("max",a,b)},_minOrMax:function(a,b,c){var d,e;this.all(function(c){e=c.map(function(a){return a[b]});d=Math[a].apply(Math,e)});this.fn(a,c).call(this,d)}})

// lawnchair-callbacks-0.6.1.min.js
Lawnchair.plugin(function(){var a="save batch get remove nuke".split(" "),b={before:{},after:{}};for(var c=0,d=a.length;c<d;c++){b.before[a[c]]=[];b.after[a[c]]=[]}return{init:function(){for(var b=0,c=a.length;b<c;b++){this.evented(a[b])}},evented:function(a){var b=this[a],c=this;this[a]=function(){var d=[].slice.call(arguments),e=d[0],f=d[d.length-1],g=false;this.fire("before",a,e);if(typeof f==="function"){d[d.length-1]=function(b){f.call(c,b);c.fire("after",a,b)};g=true}b.apply(c,d);if(!g)c.fire("after",a,e)}},fire:function(a,c,d){var e=b[a][c];for(var f=0,g=e.length;f<g;f++){e[f].call(this,d)}},clearBefore:function(a){b.before[a]=[]},clearAfter:function(a){b.after[a]=[]},before:function(a,c){b.before[a].push(c)},after:function(a,c){b.after[a].push(c)}}}())

// lawnchair-pagination-0.6.1.min.js
Lawnchair.plugin({page:function(a,b){var c=[],d=5,e=~~a||1,f=e+1,g=e-1,h=e==1?0:g*d,i=h>=d?h+d:d;this.all(function(a){c=a});var j=Math.ceil(c.length/d),a={max:j,next:f>j?j:f,prev:g==0?1:g};this.__results=a[this.name]=c.slice(h,i);if(b)this.fn("page",b).call(this,a);return this}})

// lawnchair-query-0.6.1.min.js
Lawnchair.plugin(function(){var a=function(a,b){var c=a.split("?").filter(function(a){return a!=""}),d="";for(var e=0,f=c.length;e<f;e++){d+=c[e]+b[e]}return d};var b=function(a){return function(b,c){if(b[a]<c[a])return-1;if(b[a]>c[a])return 1;return 0}};return{where:function(){var b=[].slice.call(arguments),c=b.shift(),d=b[b.length-1],e=c.match(/\?/g),f=e&&e.length>0?a(c,b.slice(0,e.length)):c,g=new Function(this.record,"return !!("+f+")"),h=[],i;this.all(function(a){for(var b=0,c=a.length;b<c;b++){if(g(a[b]))h.push(a[b])}});this.__results=h;if(b.length===1)this.fn(this.name,d).call(this,this.__results);return this},asc:function(a,c){this.fn(this.name,c).call(this,this.__results.sort(b(a)));return this},desc:function(a,c){this.fn(this.name,c).call(this,this.__results.sort(b(a)).reverse());return this}}}())
