...
//    },
   ...
   inlineText: true,
    ...
    fileExclusionRegExp: /^(.*require-1\.0\.5\.js|manifest\.json|README\.md|app\.manifest|app\.build-webstore\.js|build-webstore\.sh|build-webstore\.sh|target|etc|webstore|splashes|config\.xml|build\.txt|\.idea|.*\.sh|.*\.min\.css|.*\.min\.js|r\.js|app\.build\.js|.*phonegap.*\.js|.*json.*\.js|.*date.*\.js|.*lawnchair.*\.js|\.idea|\.git|\.gitignore|data|README)$/,
